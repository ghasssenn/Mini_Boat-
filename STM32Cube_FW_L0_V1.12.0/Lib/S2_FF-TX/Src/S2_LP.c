...
HAL_StatusTypeDef SpiritBaseConfiguration(void)
{
  ...
  tmp[1] = 0xC0; /* reg. PCKTCTRL3 (0x2E) -> ABILITO STPACKET*/
  ...
  tmp[2] = 0x30; /* reg. PROTOCOL0 (0x3B) -> METTO 3 TENTATIVI DI TRASMISSIONE: ATTENZIONE A NON METTERE AUTO ACK SUL TRASMETTITORE*/
	S2LPSpiWriteRegisters(0x39, 3, tmp);
  ...
  tmp[4] = 0x43; /* reg. PCKT_FLT_OPTIONS (0x40) QUI si dice di ricevere solo l'indirizzo di più avanti descritto */
  ...
  S2LPSpiWriteRegisters(0x45, 1, tmp);
	...
	//ABILITO IL FILTRO INDIRIZZI .. DA METTERE SUL RICEVITORE
